...
namespace Altova.Xml
{
	...
	public static class XmlTreeOperations
	{
		...
		public static XmlDocument LoadDocument( string filename )
		{
			...
			// PVHD-7029: Disable external XML resolver based on SonarQube vulnerability.
		...
		public static void SaveDocument( XmlDocument doc, string filename, bool prettyPrint, bool omitXmlDecl, string lineend )
		{
			SaveDocument( doc, filename, "UTF-8", false, false, prettyPrint, omitXmlDecl, lineend );
		}

		public static void SaveDocument( XmlDocument doc, string filename, string encoding, bool bBigEndian, bool bBOM, bool prettyPrint, bool omitXmlDecl, string lineend )
		{
			SaveDocument( doc, filename, GetEncodingObject(encoding, bBigEndian, bBOM), prettyPrint, omitXmlDecl, lineend );
		}
		
		public static void SaveDocument( XmlDocument doc, string filename, string encoding, bool prettyPrint, bool omitXmlDecl, string lineend )
		{
			SaveDocument( doc, filename, System.Text.Encoding.GetEncoding(encoding), prettyPrint, omitXmlDecl, lineend );
		}
		
		public static void SaveDocument(XmlDocument doc, System.IO.Stream stream, bool prettyPrint, bool omitXmlDecl, string lineend)
		{
			SaveDocument(doc, stream, "UTF-8", false, false, prettyPrint, omitXmlDecl, lineend);
		}

		public static void SaveDocument(XmlDocument doc, System.IO.Stream stream, string encoding, bool bBigEndian, bool bBOM, bool prettyPrint, bool omitXmlDecl, string lineend)
		{
			SaveDocument(doc, stream, GetEncodingObject(encoding, bBigEndian, bBOM), prettyPrint, omitXmlDecl, lineend);
		}

		public static void SaveDocument(XmlDocument doc, System.IO.Stream stream, string encoding, bool prettyPrint, bool omitXmlDecl, string lineend)
		{
			SaveDocument(doc, stream, System.Text.Encoding.GetEncoding(encoding), prettyPrint, omitXmlDecl, lineend);
		}
		
		public static void SaveDocument( XmlDocument doc, System.IO.Stream stream, System.Text.Encoding encoding, bool prettyPrint, bool omitXmlDecl, string lineend)
		{
		...
		public static void SaveDocument(XmlDocument doc, System.IO.TextWriter writer, bool prettyPrint, bool omitXmlDecl)
		{
			if (omitXmlDecl)
			{
				XmlWriterSettings settings = new XmlWriterSettings();
		...
		public static void SaveDocument( XmlDocument doc, string filename, System.Text.Encoding encoding, bool prettyPrint, bool omitXmlDecl, string lineend )
		{
			using (System.IO.Stream stream = System.IO.File.Create(filename))
				SaveDocument(doc, stream, encoding, prettyPrint, omitXmlDecl, lineend);
		}
