...
namespace tbf
{
	...
	public class tbf5_footageNorthSouth : Altova.TraceProvider
	{
				...
				public bool MoveNext()
				{
					while (state != 0)
					{
						...
						case 4:
							...
							var3_ref = (Altova.Functions.Core.FilterAttributes(Altova.Functions.Core.CreateQName("ref", ""), closure.var1_input)).GetEnumerator();
							goto case 6;
						case 6:
							state = 6;
							if (!var3_ref.MoveNext()) { state = 7; goto case 7; }
							current = Altova.Functions.Core.CreateAttribute(Altova.Functions.Core.CreateQName("ref", ""), Altova.Functions.Core.Box(Altova.CoreTypes.NodeToString((Altova.Mapforce.IMFNode)(var3_ref.Current))));
							pos++;
							return true;
						case 7:
							state = 0;
							Altova.Mapforce.MFEnumerator.Dispose(var3_ref); var3_ref = null;
