////////////////////////////////////////////////////////////////////////
//
// tbf/tbf17_timestampedCommentString.cs
//
...
namespace tbf
{
	...
	public class tbf17_timestampedCommentString : Altova.TraceProvider
	{
			...
			class Enumerator : Altova.Mapforce.IMFEnumerator
			{
				...
				public bool MoveNext()
				{
					while (state != 0)
					{
						...
						case 2:
							state = 3;
							var2_dTim = (Altova.Functions.Core.FilterAttributes(Altova.Functions.Core.CreateQName("dTim", ""), closure.var1_input)).GetEnumerator();
							goto case 3;
						case 3:
							state = 3;
							if (!var2_dTim.MoveNext()) { state = 4; goto case 4; }
							current = Altova.Functions.Core.CreateAttribute(Altova.Functions.Core.CreateQName("dTim", ""), Altova.Functions.Core.Box(Altova.CoreTypes.NodeToString((Altova.Mapforce.IMFNode)(var2_dTim.Current))));
							pos++;
							return true;
						case 4:
							state = 0;
