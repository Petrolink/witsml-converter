////////////////////////////////////////////////////////////////////////
//
// tbf/tbf1_ExtensionNameValue.cs
//
...
namespace tbf
{
	...
	public class tbf1_ExtensionNameValue : Altova.TraceProvider
	{
		...
		class seq1_join : IEnumerable
		{
			...
			class Enumerator : Altova.Mapforce.IMFEnumerator
			{
				...
				private IEnumerator var2_tbf2_StringMeasure;
				...
				public bool MoveNext()
				{
					while (state != 0)
					{
						...
						case 1:
							state = 2;
							var2_tbf2_StringMeasure = (tbf.tbf2_StringMeasure.Eval(closure.var1_current)).GetEnumerator();
							goto case 2;
						case 2:
							state = 2;
							if (!var2_tbf2_StringMeasure.MoveNext()) { state = 3; goto case 3; }
							current = var2_tbf2_StringMeasure.Current;
							pos++;
							return true;
						case 3:
							state = 0;
							Altova.Mapforce.MFEnumerator.Dispose(var2_tbf2_StringMeasure); var2_tbf2_StringMeasure = null;
							return false;
						}
					}
					return false;
