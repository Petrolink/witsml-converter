////////////////////////////////////////////////////////////////////////
//
// tbf/tbf5_DistanceNorthSouth.cs
//
...
namespace tbf
{
	...
	public class tbf5_DistanceNorthSouth : Altova.TraceProvider
	{
		...
		class main : IEnumerable
		{
			...
			class Enumerator : Altova.Mapforce.IMFEnumerator
			{
				...
				private IEnumerator var3_reference;
				...
				public bool MoveNext()
				{
					while (state != 0)
					{
						...
						case 4:
							...
							var3_reference = (Altova.Functions.Core.FilterAttributes(Altova.Functions.Core.CreateQName("reference", ""), closure.var1_input)).GetEnumerator();
							goto case 6;
						case 6:
							state = 6;
							if (!var3_reference.MoveNext()) { state = 7; goto case 7; }
							current = Altova.Functions.Core.CreateAttribute(Altova.Functions.Core.CreateQName("reference", ""), Altova.Functions.Core.Box(Altova.CoreTypes.NodeToString((Altova.Mapforce.IMFNode)(var3_reference.Current))));
							pos++;
							return true;
						case 7:
							state = 0;
							Altova.Mapforce.MFEnumerator.Dispose(var3_reference); var3_reference = null;
