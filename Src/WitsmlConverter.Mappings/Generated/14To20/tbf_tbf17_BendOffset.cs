...
namespace tbf
{
	...
	public class tbf17_BendOffset : Altova.TraceProvider
	{
				...
				public bool MoveNext()
				{
					while (state != 0)
					{
						...
						case 3:
							...
							if (!(Altova.Functions.Core.NodeNameEqual(Altova.Functions.Core.CreateQName("BendOffset", "http://www.energistics.org/energyml/data/witsmlv2"), (Altova.Mapforce.IMFNode)(var2_select_children.Current)))) { state = 3; goto case 3;  }
		...
		class seq1_join : IEnumerable
		{
			...
			class Enumerator : Altova.Mapforce.IMFEnumerator
			{
				...
				private IEnumerator var2_tbf2_LengthMeasure;
				...
				public bool MoveNext()
				{
					while (state != 0)
					{
						...
						case 1:
							state = 2;
							var2_tbf2_LengthMeasure = (tbf.tbf2_LengthMeasure.Eval(closure.var1_current)).GetEnumerator();
							goto case 2;
						case 2:
							state = 2;
							if (!var2_tbf2_LengthMeasure.MoveNext()) { state = 3; goto case 3; }
							current = var2_tbf2_LengthMeasure.Current;
							pos++;
							return true;
						case 3:
							state = 0;
							Altova.Mapforce.MFEnumerator.Dispose(var2_tbf2_LengthMeasure); var2_tbf2_LengthMeasure = null;
							return false;
						}
					}
					return false;
